...
const { tiraFoto, waitVisible, clearAndType, pause } = require("./cdd/utils");
const runCddTests = require("./cdd");

const BASE_URL = process.env.APP_URL || "http://localhost:3000/cdd";
...
async function main() {
  ...
  try {
    ...
    // await driver.findElement(By.id("username")).sendKeys("u");
    ...
    await runCddTests({ driver, By, until, tiraFoto });
  } finally {
